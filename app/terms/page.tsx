        ...
        <div className="container py-5">
          <div className="row justify-content-center">
            <div className="col-lg-8">
              ...
              <p className="text-muted mb-4">Last updated: 10/9/2025</p>

              <div className="card bg-tan mb-4">
                <div className="card-body">
                  <h4>1. Acceptance of Terms</h4>
                  <p>
                    By accessing and using Charity Coder, you accept and agree
              ...
              <div className="card bg-tan mb-4">
                <div className="card-body">
                  ...
                  <p>
                    ...
                    warrant that you own the rights to the content or have
              ...
              <div className="card bg-tan mb-4">
                <div className="card-body">
                  ...
                  <ul>
                    ...
                    <li>A direct link (URL) to the infringing content.</li>
                    <li>
                      A statement that you own the copyright or are authorized
                    ...
                    <li>
                      ...
                      information in your request is accurate.
                    </li>
                  </ul>
                  <p>
              ...
              <div className="card bg-tan mb-4">
                <div className="card-body">
                  ...
                  <p>
                    ...
                    completeness, or availability of the Service. Under no
                    circumstances shall Charity Coder or its affiliates be
                    liable for any damages arising from the use or inability to
                    use the Service.
                  </p>
                </div>
              </div>
              ...
              <div className="card bg-tan mb-4">
                <div className="card-body">
                  ...
                  <p>
                    ...
                    notice. Termination may result from content violations,
